...
public class ATM_INTERFACE{
    public static void main(String[]args){
        ...
        User aUser = theBank.addUser("Pallavi","Patel","12345");
        Account newAccount = new Account("Checking",aUser,theBank);
        aUser.addAccount(newAccount);
        theBank.addAccount(newAccount);
        User current_User;
        while (true){
            current_User = ATM_INTERFACE.mainMenuPrompt(theBank,sc);
            ATM_INTERFACE.printUserMenu(current_User,sc);
        }
    }
    ...
    public static void printUserMenu(User theUser,Scanner sc){
        ...
        switch(choice){
            case 1:
                ATM_INTERFACE.showTransactionHistory(theUser,sc);
                break;
            case 2:
        ...
        if(choice != 5){
            ATM_INTERFACE.printUserMenu(theUser,sc);
        }
    }
